            ...
            <tbody class="divide-y divide-gray-200">
              @foreach($books as $book)
                <tr class="hover:bg-gray-50 transition-colors">
                  ...
                  <td class="px-6 py-4">
                    <span
                      class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">{{ $book->category_name ?? 'N/A' }}</span>
                  </td>
                ...
                <td class="px-6 py-4">
                  ...
                  @else
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">Reserved</span>
                  @endif
                </td>
                <td class="px-6 py-4 text-sm text-gray-600">
                    {{ $book->published_at ? date('M d, Y', strtotime($book->published_at)) : 'N/A' }}</td>
                  <td class="px-6 py-4">
